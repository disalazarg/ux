...
RSpec.describe ProvincesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested province as @province" do
      province = Province.create! valid_attributes
      get :show, params: {id: province.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested province as @province" do
      province = Province.create! valid_attributes
      get :edit, params: {id: province.to_param}, session: valid_session
      expect(assigns(:province)).to eq(province)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Province" do
        expect {
          post :create, params: {province: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved province as @province" do
        post :create, params: {province: invalid_attributes}, session: valid_session
        expect(assigns(:province)).to be_a_new(Province)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested province" do
        province = Province.create! valid_attributes
        put :update, params: {id: province.to_param, province: new_attributes}, session: valid_session
        province.reload
      ...
      it "assigns the requested province as @province" do
        province = Province.create! valid_attributes
        put :update, params: {id: province.to_param, province: valid_attributes}, session: valid_session
        expect(assigns(:province)).to eq(province)
      end
    ...
    context "with invalid params" do
      it "assigns the province as @province" do
        province = Province.create! valid_attributes
        put :update, params: {id: province.to_param, province: invalid_attributes}, session: valid_session
        expect(assigns(:province)).to eq(province)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested province" do
      province = Province.create! valid_attributes
      expect {
        delete :destroy, params: {id: province.to_param}, session: valid_session
      }.to change(Province, :count).by(-1)
    end
